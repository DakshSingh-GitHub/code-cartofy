...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-zinc-100 font-sans selection:bg-zinc-800 selection:text-white flex flex-col justify-between">
      ...
      <header className="border-b border-zinc-800/80 bg-black/80 sticky top-0 z-30 backdrop-blur-md">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/cartofy"
              className="px-4 py-2 text-xs font-medium bg-zinc-100 hover:bg-zinc-200 text-zinc-900 rounded-md transition-all flex items-center gap-1.5"
            >
      ...
      <main className="max-w-4xl mx-auto px-6 pt-20 pb-16 text-center space-y-8 flex-1 flex flex-col items-center justify-center">
        ...
        <div className="w-full max-w-lg pt-2">
          ...
          >
            ...
            <button
              type="submit"
              className="px-4 py-2 rounded-md bg-zinc-100 hover:bg-zinc-200 text-zinc-900 text-xs font-medium transition-all shrink-0"
            >
              Analyze Repo
            </button>
          </form>
      ...
      {/* Sleek Minimalist Footer Matching Vlyxir */}
